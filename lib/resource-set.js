...
exports.create = function (rootPath) {
    ...
    resourceSet = {
        ...
        concat: function () {
            ...
            return when.resolve(sets.reduce(function (resourceSet, rs) {
                resourceSet.addResources(rs); // note: this is a potentially buggy area - a fix would be to wait for addResources to complete
