...
function resolveContent(resource) {
    return whenFn.call(resource.content.bind(resource))
        .then(function (content) {
            return { resource: resource, content: content };
        }, function () {
            return undefined;
        });
}
...
exports.create = function (options) {
    ...
    cacheRepo = {
        ...
        inflate: function (resourceSet) {
            var replace = _.bindKey(resourceSet, "addResource");
            return when.all(resourceSet.filter(etagged).map(resolveContent))
        ...
        purgeAll: function () {
            if (currentFreeze) {
                return setTimeout(_.bindKey(this, "purgeAll"),
