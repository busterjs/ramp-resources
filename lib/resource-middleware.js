...
exports.create = function (contextPath) {
    ...
    function serveBackendResource(mountPoint, resource, req, res) {
        var proxy = resource.content();
        proxy.setProxyPath(contextPath + mountPoint);
    ...
    return {
        ...
        respond: function (req, res) {
            ...
            if (resource) {
                if (resource.backend) {
                    serveBackendResource(mounted.mountPoint, resource, req, res);
                } else {
